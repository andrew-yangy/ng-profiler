 ...
 */
export interface ComponentType<T> { ɵcmp: never; }
 ...
 * consumable for rendering.
 */
export interface PipeType<T> { ɵpipe: never; }
...
export interface DirectiveDef<T> {
  ...
  providersResolver:
      (<U extends T>(def: DirectiveDef<U>, processProvidersFn?) =>
           void)|null;
...
export type DirectiveTypeList =
    (DirectiveType<any>| ComponentType<any>|
     any/* Type as workaround for: Microsoft/TypeScript/issues/4881 */)[];
...
export type PipeTypeList =
    (PipeType<any>| any/* Type as workaround for: Microsoft/TypeScript/issues/4881 */)[];
