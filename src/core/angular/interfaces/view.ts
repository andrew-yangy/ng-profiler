...
import { InjectionToken, SchemaMetadata, Type } from "@angular/core";
 ...
 */
export type TData =
    (TNode | PipeDef<any>| DirectiveDef<any>| ComponentDef<any>| number | Type<any>| InjectionToken<any>| null | string)[];
