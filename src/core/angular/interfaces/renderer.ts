...
export interface ProceduralRenderer3 {
  ...
  setStyle(
      ...
      flags?: any | RendererStyleFlags3): void;
  removeStyle(el: RElement, style: string, flags?: any|RendererStyleFlags3): void;
...
export interface RendererFactory3 {
  createRenderer(hostElement: RElement|null, rendererType: any|null): Renderer3;
  begin?(): void;
  end?(): void;
}

export const domRendererFactory3: RendererFactory3 = {
  createRenderer: (hostElement: RElement | null, rendererType: any | null):
